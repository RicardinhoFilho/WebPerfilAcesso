...
namespace WebPerfilAcesso.Controllers
{
    public class PerfilUsuariosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.PerfisUsuarios.Include(p => p.IdentityUser).Include(p => p.TipoUsuario);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var perfilUsuario = await _context.PerfisUsuarios
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdTipoUsuario"] = new SelectList(_context.TiposUsuarios, "Id", "NomeTipoUsuario");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoUsuario,UserId")] PerfilUsuario perfilUsuario)
        {
            ...
            ViewData["IdTipoUsuario"] = new SelectList(_context.TiposUsuarios, "Id", "NomeTipoUsuario", perfilUsuario.IdTipoUsuario);
            return View(perfilUsuario);
        }
        ...
        {
            return _context.PerfisUsuarios.Any(e => e.Id == id);
        }
    }
}
